...
full_idxtf1,full_idxtb1,full_idxt1=getind(number_of_streamlines,particles_per_streamline+2)

#initialize orbits
r, t, vr, vt, lambda0, c = initialize_streamline(number_of_streamlines, particles_per_streamline,
    radial_width, total_ring_mass, G_ring, Q_ring, shear_viscosity, J2, Rp, initial_orbits,full_idxtf1,full_idxtb1,full_idxt1)
...
while (number_of_outputs < total_number_of_outputs):
    ...
    vr, vt = kick(J2, Rp, lambda0, G_ring, shear_viscosity, c, r, t, vr, vt, dt/2.0,full_idxtf1,full_idxtb1,full_idxt1)
    ...
    while (timesteps_since_output < timesteps_per_output):
        ...
        #kick velocities
        vr, vt = kick(J2, Rp, lambda0, G_ring, shear_viscosity, c, r, t, vr, vt, dt,full_idxtf1,full_idxtb1,full_idxt1)
        #updates
        timestep += 1
