...
\revised{not yet}
\accepted{not yet}
\submitjournal{\apj, March 3, 2025}
...
\affiliation{Department of Astronomy, The Ohio State University, Columbus, 140 W 18th Ave, OH 43210, USA}
...
The epi\_int\_lite N-body integrator uses the same {\bf second-order sympletic} drift-kick
...
The particle's {\bf Eulerian} acceleration due to the ring particles' shear viscosity is
\begin{equation}
...
and $\omega=v_\theta/r$ is the particle's angular velocity
{\bf (Appendix A of \citealt{HS13})}.
...
\begin{figure}
    \plotone{nominal_sigma_vs_longitude.pdf}
    \caption{
...
\begin{figure}
    \plotone{radial_sigma_nominal.pdf}
    \caption{
...
\end{equation}
where $\sigma_0 = \lambda/\Delta a$ is the ringlet's initial surface density assuming
...
\begin{figure}
    \plotone{angular_momentum_luminosity_nominal.pdf}
    \caption{
...
\begin{figure}
    \plotone{angular_momentum_luminosity_zoom_nominal.pdf}
    \caption{
...
\begin{figure}
    \plotone{F_vs_longitude_nominal.pdf}
    \caption{
        ...
        (orange curve) {\bf computed using Eqn.\ (\ref{eqn:grav_ang_mom_flux}).}
    }
\end{figure}
...
\begin{figure}
    \plotone{F_energy_vs_longitude_nominal.pdf}
    \caption{
...
\begin{figure}
    \plotone{nominal_energy_luminosity.pdf}
    \caption{
...
\begin{figure}
    \gridline{\fig{sim_grid_da_0p000025.pdf}{0.5\textwidth}{}\fig{sim_grid_da_0p00005.pdf}{0.5\textwidth}{}}
    \gridline{\fig{sim_grid_da_0p0001.pdf}{0.5\textwidth}{}\fig{sim_grid_da_0p0001.pdf}{0.5\textwidth}{}}
    \gridline{\fig{sim_grid_da_0p0002.pdf}{0.7\textwidth}{}}
    \caption{
...
for nine ringlets; see quantities $q_{em}=e'$ and $q_{\tilde{\omega}m}=\tilde{\omega}'$ where $m=1$
in Table 14 of F24. Nearly all of the ringlets monitored in F24 have 
...
\begin{figure}
    \plotone{e_vs_da_streamlines.pdf}
    \caption{
...
\end{figure}
\begin{figure}
    \plotone{delta_wt_vs_da_streamlines.pdf}
    \caption{
...
\begin{figure}
    \plotone{periapse_sigma_vs_r_streamlines.pdf}
    \caption{
...
\end{figure}
\begin{figure}
    \plotone{apoapse_sigma_vs_r_streamlines.pdf}
    \caption{
...
was composed and developed while at the Water Tank karaoke bar in northwest Austin TX, and the authors thank
proprietor James Stryker for his hospitality.
The authors also thank Joe Spitale for comments about this work.
...
\begin{figure}
    \plotone{de_prime_nogravity.pdf}
    \caption{
