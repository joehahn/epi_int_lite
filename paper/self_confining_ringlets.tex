...
%
%to compile:    pdflatex self_confining_ringlets.tex
...
simulate the outer edge of Saturn's B ring that is sculpted by resonant perturbations
from satellite Mimas (ref). Although the epi\_int integrator is well-suited to evolve the
B ring edge over the $10^4$ orbits needed to monitor the B ring's response to Mimas,
that code was unable evolve with sufficient accuracy over the $10^6$ orbits needed
to investigate a viscous ringlet's slow radial spreading, with that inability
...
\begin{figure}[ht!]
\plotone{figs/cost-eps-converted-to.pdf}
...
\begin{figure}
\plottwo{figs/RS_Oph-eps-converted-to.pdf}{figs/U_Sco-eps-converted-to.pdf}
...
\begin{figure*}
\gridline{\fig{figs/V2491_Cyg-eps-converted-to.pdf}{0.3\textwidth}{(a)}
          \fig{figs/CSS081007-eps-converted-to.pdf}{0.3\textwidth}{(b)}
          \fig{figs/LMC_2009-eps-converted-to.pdf}{0.3\textwidth}{(c)}
          }
\gridline{\fig{figs/RS_Oph-eps-converted-to.pdf}{0.3\textwidth}{(d)}
          \fig{figs/U_Sco-eps-converted-to.pdf}{0.3\textwidth}{(e)}
          }
\gridline{\fig{figs/KT_Eri-eps-converted-to.pdf}{0.3\textwidth}{(f)}}
...
\figsetplot{figs/KT_Eri-eps-converted-to.pdf}
...
\figsetplot{figs/RS_Oph-eps-converted-to.pdf}
\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
outburst.}
\figsetgrpend
...
\figsetplot{figs/U_Sco-eps-converted-to.pdf}
\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
outburst.}
\figsetgrpend
...
\figsetplot{figs/V2491_Cyg-eps-converted-to.pdf}
\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
outburst.}
\figsetgrpend
...
\figsetplot{figs/LMC_2009-eps-converted-to.pdf}
\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
outburst.}
\figsetgrpend
...
\figsetplot{figs/CSS081007-eps-converted-to.pdf}
\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
outburst.}
\figsetgrpend
...
\figsetplot{figs/V2672_Oph-eps-converted-to.pdf}
\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
outburst.}
\figsetgrpend
...
\figsetplot{figs/V407_Cyg-eps-converted-to.pdf}
\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
outburst.}
\figsetgrpend
...
\begin{figure}
\plotone{figs/KT_Eri-eps-converted-to.pdf}
...
\begin{figure}
\plotone{figs/video3-eps-converted-to.pdf}
