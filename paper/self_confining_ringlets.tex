...
nonlinear density waves. For an example, see also \cite{Fetal16B} for a simulation
...
warped ring plane is no longer purely vertical {\it i.e.} the wave's forcing of the ring-plane
within distances $\sim\lambda_b$ will also have a radial component. And that radial forcing of a
...
eventually go nonlinear in a way that might possibly spawns a spiral density wave, which
might be observable in Cassini observations of Saturn's rings.
