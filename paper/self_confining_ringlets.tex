...
In this work, a suite of N-body simulations are used to investigate whether ringlet
self-gravity can cause a narrow eccentric ringlet to evolve into a 
...
Possibly as a small embedded moonlet that generate the propeller structures
...
a dense planetary ring can also birth multiple such moonlets, and the ring-torque would also 
cause the largest moonlet to overtake any smaller moonlets. Which will encourage
...
$\lambda_b$ is large compared to bending wave amplitude $A$, which is the ring plane's maximal
