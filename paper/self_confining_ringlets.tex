...
And when a ringlet is displaced slightly from equilibrium, it 
librates about the equilibrium point (\ref{eqn:e_prime_eq}) 
...
That Fig.\ compares predicted libration periods (dashed curves) versus simulated $T_\text{lib}$
(dotted curves) for the suite of narrow and wide ringlets. The rightmost halves of the blue and green curves show that the
...
\begin{figure}
    ...
    \caption{
        ...
        simulated in Fig.\ \ref{fig:equilibrium}. Dotted curves are the simulated outcomes while dashed
        curves are the theoretical predictions, Eqn.\ (\ref{eqn:T_lib}).
    }
\end{figure}
