...
that indicate the ringlet's streamlines' locations and orientations, with the N-body
integrator used to compute the orbital evolution of those trace particles
due to perturbations from those streamlines. The streamline approach used here allows one to
track the global evolution of the ringlet's streamlines
...
The particle's tangential acceleration due to the ringlet's viscosity is
\begin{equation}
\label{eqn:shear_viscosity}
    A_{\nu, \theta}=-\frac{1}{\sigma r}\frac{\partial {\cal F}_L}{\partial r},
\end{equation}
