...
\end{equation}
and this radial energy flux is due to the ringlet's viscosity and self-gravity so
${\cal F}_E = {\cal F}_{E,\nu} + {\cal F}_{E,g}$. 
...
\end{equation}
and this is the rate that the interior streamlines communicate energy to streamline $a$.
...
shows that this gravitating ringlet's spreading had ceased by time $t \simeq60\tau_\nu$, 
...
its positive viscous angular momentum luminosity ${\cal L}_{L,\nu}\simeq0.006{\cal L}_{L,\nu,c}$ 
is counterbalanced by its negative gravitational angular momentum luminosity ${\cal L}_{L,g}\simeq {\cal L}_{L,\nu}$,
...
%will show that this ringlet's energy luminosity ${\cal L}_E$ is zero. 
%Evidently it is 
...
\begin{figure}
    ...
    \caption{
        ...
        Figure \ref{fig:angular_momentum_luminosity_nominal} is replotted to demonstrate that the ringlet's 
        ...
        while balanced by the ringlet's negative ({\it i.e.}\ inwards) gravitational angular momentum luminosity 
...
and gravitational energy luminosity ${\cal L}_{E,g}$ over time, with the
gravitational energy momentum luminosity computed via
\begin{equation}
    \label{eqn:L_g}
