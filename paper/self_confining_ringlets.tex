...
(which is still quite speculative) argues that
the ringlet precursor was originally an especially large ring particle that was orbiting elsewhere such as
within a dense planetary ring, presumably as an embedded moonlet aka propeller (\cite{Tetal10}). 
...
and lasts only $\sim{\cal O}(1000)$ years due to ringlet viscosity damping the ringlet's eccentricity until its inner edge gets circularized and causes the ringlet's $q$ to then 
drop below the self-confinement threshold, $q\simeq\sqrt{3}/2$.
