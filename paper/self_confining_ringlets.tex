...
\begin{figure}
    ...
    \caption{
        ...
        nominal ringlet except they contain various numbers of streamlines $2\le N_s\le14$,
        with plot legend indicating the simulation's number of streamlines $N_s$.
        Simulated ringlets' final eccentricities $e$ are plotted versus their relative
        semimajor axis $\Delta a=a-\bar{a}$ where $\bar{a}$ is the mean semimajor
...
\begin{figure}
    ...
    \caption{
        ...
        semimajor axis $\Delta a=a-\bar{a}$, where $\bar{a}$ is the mean semimajor axes 
        of all particles in the ringlet, and $\bar{\omega}$ is their mean longitude of periapse.
        Plot legend indicates each simulation's number of streamlines $N_s$.
    }
\end{figure}
