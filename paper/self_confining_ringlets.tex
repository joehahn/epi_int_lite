...
\item {\it Asymmetric circumstellar debris disk}: a debris disk is a dusty circumstellar disk that is often foundin orbit about a relatively young star, $\sim10^{7-9}$ years \citep{Matthews18}, 
and is possibly a signature of ongoing planet formation. Many such stars are suspected of hosting an unseen
planetesimal `birth ring', wherein collisions among those planetesimals generates dust whose smaller grains are 
be launched into very wide eccentric orbits due to stellar radiation pressure \citep{SC06}.
...
routinely exhibit surface-brightness asymmetries as well other substructures that can be 
attributed to giant impacts among planetesimals and/or gravitational forcing by
unseen protoplanets (\citealt{Jetal23}). The longevity of these disks, which is inferred from the 
host star's $10^{7+}$ yr age, suggests that these birth rings can be long-lived despite the
planetesimal-planetesimal collisions and scatterings that might cause such a ring to diffuse radially. 
Which causes us to wonder whether the birth-ring's self gravity could play a role in preserving a
birth ring's narrowness via the self-confinement mechanism considered here.
