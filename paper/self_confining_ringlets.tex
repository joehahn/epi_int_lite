...
\begin{figure}
    ...
    \caption{
        ...
        indicate those ringlets that evolve into the self-confining state, with an x
        for those simulations that terminate early when an epi\_int\_lite particle crossed an adjacent streamline,
        and N to indicate the nominal ringlet. The color of each self-confining ringlet indicates
        whether the ringlet settled into a high--eccentricity gradient state with $e'> 0.86$ (dark blue),
        ...
        The right-middle plot is redundant, please ignore.
    }
\end{figure}
