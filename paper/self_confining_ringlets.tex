...
\begin{figure}
    ...
    \caption{
        ...
        The middle-right plot is redundant, is here to trick latex into rendering all plots on same page, please ignore.
    }
\end{figure}
...
UPDATE: The evolution of
a selection of partially self confined ringlet simulations, as well as the nominal ringlet whose ID=338, 
