...
In short, a self-confining ringlet's radial surface density profile is smooth and is
concave--down with sharp edges.
...
Eyeball inspection of the Maxwell ringlet's radial optical depth profiles can be approximately 
described as concave--downish with a spiral density wave on top (\citealt{Netal14}). The Titan
...
and lots of internal structure.
