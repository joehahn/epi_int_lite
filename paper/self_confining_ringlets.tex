...
The simulated ringlet has the same physical properties as the nominal ringlet but is instead circular and has 
...
\begin{figure}
    ...
    \caption{
        ...
        Solid theoretical curves are from Eqn.\ (2.13) of \cite{P81} and constant $\bar{\sigma}=m_r/\pi r_{mid}^2$.
    }
\end{figure}
