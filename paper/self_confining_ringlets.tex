...
and initial eccentricity $e=0.01$, and see Section \ref{subsec:nominal} to convert
...
\begin{figure}
    ...
    \caption{
        ...
        showing outer streamline's longitude of periapse $\tilde{\omega}$ trailing
...
\begin{figure}
    ...
    \caption{
        ...
        longitude $\varphi$ at selected times $t$. That the ringlet's surface
        density maxima occurs just before peripase is due to the ringlet's
...
The ringlet's evolution is readily understood when the ringlet's viscous flux of angular momentum is 
...
\item $e'\ge\sqrt{3}/2$. Viscous angular momentum flux reversal is complete such that $L_\nu<0$,
...
with the ringlet's total angular momentum luminosity $L=L_\nu+L_g=0$ is very close to zero.
...
it's positive viscous angular momentum luminosity $L_\nu$ is nearly counterbalanced
by it's negative gravitational angular momentum luminosity $L_g$. 
...
\begin{figure}
    ...
    \caption{
        ...
        as well as the ringlet's gravitational angular momentum flux $F_{g}(\varphi)$ 
        in units of $F_{\nu,0}$ (orange curve).
    }
\end{figure}
...
momentum radially through the self-confining ringlet at various longitudes $\varphi$. To compute
the ringlet's gravitational angular momentum flux $F_g$, note that the gravitational torque that is exerted on
a small streamline segment of mass $\delta m$ due to the ring material orbiting interior is
$T_g=\delta m r A^1_{g,\theta}=F_g\delta\ell$, where $A^1_g$ is the so-called one-sided gravitational acceleration
{\it i.e.}\ the gravitational acceleration that segment $\delta m$ experiences due to the ring matter orbiting interior to it.
The tangential component of that one-sided acceleration is
$A^1_{g,\theta}$, so for a segment whose length is $\delta\ell$, its gravitational angular momentum flux is
$F_g=\lambda r A^1_{g,\theta}$ where $\lambda=m_r/Ns/2\pi a$ is the streamline's linear density.
