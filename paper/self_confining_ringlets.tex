...
warped ring plane are no longer purely vertical {\it i.e.} the wave's forcing of the ring-plane
...
\item {\it Asymmetric circumstellar debris disk}: a debris disk is a dusty circumstellar disk that is often foundin orbit about a young star, and is associated with ongoing planet formation. If for instance
planetesimals are confined to an unseen ring, collisions
