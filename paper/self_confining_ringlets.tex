...
Fig.\ \ref{fig:angular_momentum_luminosity_zoom_nominal} show that the ringlet's positive
viscous angular momentum luminosity $L_\nu$ is nearly matched by the by the ringlet's negative
gravitational angular momentum luminosity $L_g$. {\em But I still need to explain why $L$ isn't precisely zero 
when ringlet is seemingly self--confining...}
