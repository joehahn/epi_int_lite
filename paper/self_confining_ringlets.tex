...
\begin{figure}
    ...
    \caption{
        ...
        the non-gravitating ringlet's $\Delta a$ is never confined due to the ringlet's
        much lower eccentricity gradient. Also note that planetary oblateness
        cause the non-gravitating streamlines to precess differentially when $J_s>0$, 
        eventually causing them to cross, so the non-gravitating simulation sets $J_2=0$
