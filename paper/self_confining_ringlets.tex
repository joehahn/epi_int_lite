...
casts doubt upon those ringlet confinement mechanism.
...
which causes the ringlet's nonlinearity parameter to shrink below the 
...
are also exciting the ringlet's eccentricity.
...
would generate debris that could quickly
