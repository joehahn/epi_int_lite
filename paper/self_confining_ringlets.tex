...
shape {\it i.e.} the ringlet's eccentricities still slowly evolving despite
...
\begin{figure}
    ...
    \caption{
        ...
        with inset plot showing that $\Delta e$ continues  slow growth despite self-confinement. 
    }
\end{figure}
